...
variable "log_retention_days" {
  ...
  validation {
    ...
    error_message = "log_retention_days must be a valid CloudWatch retention value: 0 (never expire), 1, 3, 5, 7, 14, 30, 60, 90, 120, 150, 180, 365, 400, 545, 731, 1096, 1827, 2192, 2557, 2922, 3288, or 3653."
  }
}
